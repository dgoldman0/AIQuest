...
async def handle_interactions(user_id):
    ...
    while True:
        ...
        if response.lower().startswith("yes"):
            changed = True
            prompt = generate_prompt("characters/update_setting", (realm[1], location[1], location[2], scenario, setting, character[0], message, gm_response, ))
